            ...
            {editing ? (
                <MenuItem disableRipple>
                    ...
                    <Button onClick={handleRename} size="small">
                        {t('pages.statistics.charts.pie.actions.custom-column-menu.ok')}
                    </Button>
                </MenuItem>
            ) : (
                [
                    ...
                    >
                        ...
                        {t('pages.statistics.charts.pie.actions.custom-column-menu.renameColumn')}
                    </MenuItem>,
                    <MenuItem
                        key="delete"
                    ...
                    >
                        ...
                        {t('pages.statistics.charts.pie.actions.custom-column-menu.deleteColumn')}
                    </MenuItem>,
                ]
            )}
