...
export function Demo02View() {
    ...
    const createParallelogram = (board: JXG.Board) => {
        ...
        // Tạo điểm D sao cho ABCD là hình bình hành (AB // CD, AD // BC)
        ...
        // Vẽ các cạnh
        board.create('segment', [A, B], { strokeColor: '#1f77b4', strokeWidth: 2 });
        board.create('segment', [B, C], { strokeColor: '#ff7f0e', strokeWidth: 2 });
        board.create('segment', [C, D], { strokeColor: '#2ca02c', strokeWidth: 2 });
        board.create('segment', [D, A], { strokeColor: '#d62728', strokeWidth: 2 });
    };
    ...
    const createTriangle = (board: JXG.Board) => {
        ...
        board.create('segment', [A, B], { strokeColor: '#1f77b4', strokeWidth: 2 });
        board.create('segment', [B, C], { strokeColor: '#ff7f0e', strokeWidth: 2 });
        board.create('segment', [C, A], { strokeColor: '#2ca02c', strokeWidth: 2 });
    };
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            <Card>
                <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary" gutterBottom>
                        Di chuyển các điểm A, B, C - điểm D sẽ tự động điều chỉnh để giữ tính chất hình bình hành
                    </Typography>
                    <div 
            ...
            <Card>
                <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary" gutterBottom>
                        Di chuyển các điểm A, B - điểm C và D sẽ tự động điều chỉnh để giữ tính chất hình vuông
                    </Typography>
                    <div 
                        id="square-container" 
                        ref={squareBoardRef}
