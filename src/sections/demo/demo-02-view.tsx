                ...
                <Card key={index}>
                    <CardContent>
                        ...
                        <Typography variant="body2" color="text.secondary" paragraph>
                            This is card number {index + 1}. This content is repeated multiple times
                            to create a scrollable area. The header (title and description) should
                            remain fixed at the top while only this content area scrolls.
                        </Typography>
                        <Typography variant="body2" color="text.secondary" paragraph>
