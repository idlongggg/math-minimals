...
export function FullscreenIcon({ sx, ...other }: SvgIconProps) {
  return (
    <SvgIcon sx={sx} {...other}>
      <g fill="none">
        <path 
          ...
          clipRule="evenodd" 
        />
        <path fill="url(#fluentColorSearchVisual240)" d="M12 15a3 3 0 1 0 0-6a3 3 0 0 0 0 6M7.5 8.75a1.25 1.25 0 1 0 0-2.5a1.25 1.25 0 0 0 0 2.5" />
        <defs>
          <radialGradient 
          ...
          <linearGradient 
            ...
            gradientUnits="userSpaceOnUse"
          >
            <stop offset={0.015} stopColor="#3dcbff" />
