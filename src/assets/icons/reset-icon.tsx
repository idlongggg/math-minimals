...
export function ResetIcon({ sx, ...other }: SvgIconProps) {
  return (
    <SvgIcon sx={sx} {...other}>
      <g fill="none">
        <path fill="url(#fluentColorHistory240)" d="M12 7a1 1 0 0 1 1 1v3h2a1 1 0 1 1 0 2h-3a1 1 0 0 1-1-1V8a1 1 0 0 1 1-1" />
        <path 
