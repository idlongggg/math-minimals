...
export function SettingsProvider({
  ...
  const cleanedCookieSettings = cookieSettings
    ? cleanSettings(removeDeprecatedProperties(cookieSettings))
    : undefined;
    ...
    if (storedValue) {
      try {
        ...
        if (
          ...
          cleanedStoredValue.version !== cleanedDefaultSettings.version
        ) {
          onReset();
        } else {
