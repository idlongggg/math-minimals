...
import { ActionsTab, OverviewTab } from 'src/sections/statistics/charts/histogram';

export default function HistogramStatisticsPage() {
    ...
    return (
        <PageLayout
            pageKey="statistics.charts.histogram"
            tabs={tabs}
            tabValue={currTab}
